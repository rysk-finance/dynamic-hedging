...
export const formatEth = (x: BigNumberish = 0) => Number(utils.formatEther(x));
...
export const toWeiFromUSDC = (x: string = "0") => utils.parseUnits(x, 12);
export const fromWeiToUSDC = (x: string = "0") =>
...
export const fromRysk = (x: string = "0") => utils.formatUnits(x, 18);
