...
export declare namespace AlphaPortfolioValuesFeed {
  ...
  export type OptionStoresStructOutput = [
...
export interface IAlphaPortfolioValuesFeedInterface extends utils.Interface {
...
export interface IAlphaPortfolioValuesFeed extends BaseContract {
  contractName: "IAlphaPortfolioValuesFeed";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAlphaPortfolioValuesFeedInterface;
  ...
  functions: {
    ...
    storesForAddress(
      ...
      overrides?: CallOverrides
    ): Promise<[AlphaPortfolioValuesFeed.OptionStoresStructOutput]>;
