...
export interface NewMarginCalculatorInterface extends utils.Interface {
  functions: {
    ...
    "isLiquidatable((address[],address[],address[],uint256[],uint256[],uint256[]),uint256)": FunctionFragment;
  ...
  events: {
    ...
    "LiquidationMultiplierUpdated(uint256)": EventFragment;
...
export interface NewMarginCalculator extends BaseContract {
  ...
  functions: {
    ...
    getMarginRequired(
      ...
      _vaultType: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[FixedPointIntStructOutput, FixedPointIntStructOutput]>;
  ...
  filters: {
    ...
    "LiquidationMultiplierUpdated(uint256)"(
      liquidationMultiplier?: null
