...
export const WITHDRAW_ESTIMATE_MESSAGE =
  "Values are estimates based on the current position of the vault. Your withdraw will be executed on Friday at 11am UTC. The final amount you will receive could differ from the value shown.";
