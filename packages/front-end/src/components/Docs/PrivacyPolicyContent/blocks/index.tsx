...
export const UseOfYourData = () => (
  <>
    ...
    <ul>
      ...
      <li>{`to enforce the Privacy Policy or User Terms;`}</li>
...
export const Analytics = () => (
  <>
    ...
    <p>
      {`However, if you would like to entirely exclude your anonymized visits from showing up in our analytics, please go to the Fathom Analytics Exclude Your Visits page for opt-out instructions at the following link: `}
      <a
        href="https://usefathom.com/"
        rel="noopener noreferrer"
        target="_blank"
...
export const Cookies = () => (
  <>
    ...
    <p>{`A cookie is a small string of text that a website (or online service) stores on a user’s browser. It saves data on your browser about your visit to our site or other sites. It often includes a unique identifier (e.g., cookie #123).`}</p>
    ...
    <ul>
      ...
      <li>
        ...
        {` are cookies set by other companies whose functionality is embedded into a site (e.g., google.com).`}
      </li>
      <li>
        <em>{`"Session cookies"`}</em>
        {` are temporary cookies stored on your device while you visit the Interface. They expire when you close your browser.`}
      </li>
      <li>
        <em>{`"Persistent cookies"`}</em>
        {` are stored on your browser for a period of time after you leave the Interface. Persistent cookies expire on a set expiration date or when they are deleted manually.`}
      </li>
    </ul>

    <h4>{`Disabling Cookies Through Your Browser`}</h4>

    <p>
      {`Most browsers automatically accept cookies, but this is typically something you can adjust. Information for each browser can be found at `}
      <a
        href="https://www.cookiesandyou.com/disable-cookies/"
        rel="noopener noreferrer"
        target="_blank"
      >
        {`Cookies & You`}
...
export const AccessingAndEditingYourInformation = () => (
  <p>
...
export const OptOut = () => (
  <>
    ...
    <p>
      {`If you wish to opt out of certain communications or data collection, please contact us at `}
      <a href="mailto:privacy@rysk.finance">{`privacy@rysk.finance`}</a>
      {`.`}
    </p>
  </>
...
export const Rights = () => (
  <>
    ...
    <p>{`You have the right to withdraw your consent to the processing of your personal data at any time.`}</p>

    <h4>{`Right of access`}</h4>
    <p>{`You have the right to obtain access to the personal information collected about you, as well as its sources, purpose, and sharing.`}</p>

    <h4>{`Right to rectification`}</h4>
    <p>{`You have the right to obtain the rectification of inaccurate or incomplete personal data concerning you without undue delay.`}</p>

    <h4>{`Right to erasure`}</h4>
    <p>{`You have the right to obtain the deletion of your personal data without undue delay.`}</p>
    ...
    <p>{`You have the right to obtain the restriction of processing of your personal information if:`}</p>
    <ul>
      <li>{`the user disputes the accuracy of personal information about him or her;`}</li>
      <li>{`the user claims that the processing is unlawful;`}</li>
      <li>{`the user claims that the controller no longer needs to retain the information for the establishment, exercise, or defense of a legal claim;`}</li>
      <li>{`the user objects to the processing pending verification as to whether the data controller's legitimate grounds prevail over those of the data subject.`}</li>
    </ul>
    ...
    <h4>{`Automated individual decision-making`}</h4>
    <p>
    ...
    <p>
      {`In the event that you wish to exercise any of your above rights, please contact us at `}
      <a href="mailto:privacy@rysk.finance">{`privacy@rysk.finance`}</a>
      {`.`}
    </p>
  </>
