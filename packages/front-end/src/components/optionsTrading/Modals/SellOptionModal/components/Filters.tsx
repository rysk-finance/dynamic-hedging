...
export const Filters = () => {
  ...
  return (
    <div className="flex flex-col w-3/5 mx-auto pt-4 select-none">
      ...
      <RyskTooltip
        content="This slider allows you to select the level at which you will collateralise your position. Higher multiples of collateral will be safer whilst lower levels will have higher risk."
        disabled={!tutorialMode}
      >
