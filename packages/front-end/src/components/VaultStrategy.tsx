...
const STRATEGY_DETAILS = [
  ...
  },
  {
    ...
    description:
      "The Short Straddle is a neutral options strategy. This strategy involves simultaneously selling a call and a put option of the same underlying asset, same strike price and same expire date.",
  },
];
      ...
      <div className="grid grid-cols-2">
        <div>
          ...
          <div className="rounded-lg mt-8 mr-8">
            <div className="pb-4">
              <Button onClick={() => setStrategy("strangles")}>
                Strangles
              </Button>
              <Button onClick={() => setStrategy("straddles")}>
                Straddles
              </Button>
            </div>
          ...
          <p className="pt-4 pr-4">
            ...
            <div className="rounded-lg mt-8 mr-8">
              <div className="pb-4">
                ...
                <Button onClick={() => setHedging("perpetuals")}>
                  Perpetuals
                </Button>
