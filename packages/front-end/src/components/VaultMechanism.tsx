        ...
        <div>
          ...
          <p className="pt-4">
            <ul className="list-decimal px-8">
              ...
              <li className="pb-2">
                Your USDC deposit will be queued till the start of the next
                epoch. You can continue to deposit USDC until this time.
              </li>
              <li className="pb-2">
                Once the new epoch starts your deposit will be converted to
                shares which can then be redeemed. After have redeemed, you have
                full control of your {DHV_NAME} shares and you will be able to
                see them in your wallet as ERC20 tokens.
              </li>
              <li className="pb-2">
                The deposited funds are used to fund ETH options strategies.
              </li>
              <li className="pb-2">
                Your shares&apos; value could appreciate over time as the{" "}
                {DHV_NAME} generates returns.
              </li>
            </ul>
          </p>
          ...
          <p className="pt-4">
            <ul className="list-decimal px-8">
              <li className="pb-2">
                You can withdraw all or part of your shares. You are able to
                initiate a withdrawal at any time.
              </li>
              <li className="pb-2">
                Your withdrawal will be queued until the next epoch.
              </li>
              <li className="pb-2">
            ...
            <div>
              <div className="border-black border-2 rounded-b-lg p-8 overflow-hidden bg-bone">
                <div className="flex justify-around items-center">
                  <img src="/images/epoch.png" className="mr-8 h-[150px]" />
                  {/* <p>
                  ...
                  <p>
                    ...
                    <br />
                    Deposits and withdrawals will be on hold until the current
                    epoch ends.
                    <br />
                    At the start of the new epoch, the deposits will be deployed
                    into the {DHV_NAME} vault and the withdrawals could be
                    redeemed for USDC.
                    <br />
