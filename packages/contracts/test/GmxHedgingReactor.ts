...
describe("GMX Hedging Reactor", () => {
	...
	it("opens a long position", async () => {
		...
		checkPositionExecutedEvent(delta)
	...
	it("closes the long position at a loss", async () => {
		...
		await executeDecreasePosition()
		checkPositionExecutedEvent(delta / 2)
