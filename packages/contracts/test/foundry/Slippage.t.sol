...
contract SlippageTest is Test {
	...
	function _getSlippageMultiplier(
		...
		if (_isSell) {
			console.logInt((slippageFactor.pow(-oldExposureExponent) - slippageFactor.pow(-newExposureExponent)));
			...
			console.logInt((slippageFactor.pow(-newExposureExponent) - slippageFactor.pow(-oldExposureExponent)));
