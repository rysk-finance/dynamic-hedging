...
interface IAccounting {
     ...
     */
	function redeem(address redeemer, uint256 shares) external view returns (uint256 toRedeem, DepositReceipt memory depositReceipt);
     ...
     */
    function initiateWithdraw(address withdrawer, uint256 shares) external view returns (WithdrawalReceipt memory withdrawalReceipt);
     ...
     * @return withdrawalReceipt the new withdrawal receipt to pass to the liquidityPool
     */
    function completeWithdraw(address withdrawer, uint256 shares) external returns (int256 amountNeeded, uint256 withdrawalAmount, uint256 withdrawalShares, WithdrawalReceipt memory withdrawalReceipt);
